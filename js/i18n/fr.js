...
export default {
  ...
  game: {
    ...
    pauseTitle: 'Pause',
    undoTitle: 'Annuler',
    sortTitle: 'Trier la réserve',
    hintTitle: 'Indice',
    noHint: 'Aucun indice disponible pour l’instant.',
  ...
  tutor: {
    ...
    next: 'Suivant',
    apply: 'Compris – appliquer',
    direct: { look: 'Regarde ce calcul : {eq}. Il ne manque plus qu’UN nombre.', solve: 'Il se calcule donc sans ambiguïté : {eq}.' },
    combo: { look: 'Regarde ce calcul : {eq}. Plusieurs nombres manquent …', only: '… mais une SEULE combinaison de la réserve convient ({n} cases).' },
    cross: { look: 'Cette case appartient à {n} calculs à la fois.', only: 'Un seul nombre convient aux deux : {a} et {b}.' },
    pool: { look: 'Le {v} est {n} fois dans la réserve.', only: 'Et il ne rentre que dans {n} cases – chacune reçoit donc un {v}.' },
    place: 'C’est donc le {v} qui va ici.',
    placeMulti: '{n} cases sont ainsi déterminées.',
  },
  achievements: {
    title: 'Succès',
