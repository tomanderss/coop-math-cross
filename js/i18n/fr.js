...
export default {
  ...
  endless: { badge: 'Sans fin', best: 'Meilleure partie : niveau {n}', cleared: 'Niveau {n} réussi !', lifeGained: '+1 vie', overTitle: 'Partie terminée', reached: 'Niveau {n} atteint', record: 'Nouveau record !', levelDone: 'Niveau {n} réussi !', continue: 'Continuer', livesLabel: 'Vies', levelShort: 'Niveau {n}', levelTime: 'Temps de ce niveau', totalTime: 'Temps total de la partie', backfillToast: 'Anciennes parties sans fin créditées : {wins} victoires de {runs} parties comptent désormais dans tes statistiques !', waitingForNextLevel: 'Niveau {level} réussi — en attente de l’hôte pour le niveau suivant …' },
  ...
  settings: {
    ...
    dragScale: 'Portée du glisser',
    dragScaleHint: "La tuile déplacée suit votre doigt de façon amplifiée : à 3x, un petit geste la déplace trois fois plus loin, vous atteignez le haut de la grille sans traverser tout l'écran. Elle est posée là où elle est affichée.",
    dragScaleOff: '1x (désactivé)',
    dragScaleOn: '{f}x',
    colorBlindMode: 'Mode daltonien',
    colorBlindModeHint: 'Remplace le vert/rouge partout dans le jeu (correct/incorrect, vies, couleurs coop, ...) par des teintes plus distinguables pour la déficience visuelle rouge-vert/bleu-jaune.',
    coop: 'Coopératif',
  ...
  training: {
    ...
    step: { direct: 'Il ne manque qu’un nombre dans ce calcul : {eq} → le {v}.' },
  },
  achievements: {
    title: 'Succès',
    ...
    perfectWin: { title: 'Sans faute', desc: 'Résous un puzzle sans la moindre erreur.' },
    perfectTen: { title: 'Série sans faute', desc: 'Gagne 10 puzzles sans erreur.' },
    ...
    bigPerfect: { title: 'Grand et parfait', desc: 'Gagne une grille Grands nombres sans erreur.' },
  ...
  howto: {
    title: 'Comment jouer',
    rule1: 'Place les nombres de la <b>réserve</b> en bas dans les cases vides : <b>fais-les glisser</b> ou <b>touche</b> un nombre puis la case.',
    ...
    rule4: 'Deux tuiles posées <b>échangent</b> leur place : touche la première (elle reste sélectionnée), puis la seconde. Le glisser-déposer marche aussi.',
  ...
  a11y: {
    cellLabel: 'Ligne {row}, colonne {col}, {status}',
    cellGiven: 'donné',
    cellEmpty: 'vide',
    cellFilled: 'contient {value}',
  },
  error: {
  },
};
