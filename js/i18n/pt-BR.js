...
export default {
  ...
  game: {
    ...
    pauseTitle: 'Pausa',
    undoTitle: 'Desfazer',
    sortTitle: 'Ordenar a reserva',
    hintTitle: 'Dica',
    noHint: 'Nenhuma dica disponível agora.',
  ...
  tutor: {
    ...
    next: 'Avançar',
    apply: 'Entendi – aplicar',
    direct: { look: 'Veja esta conta: {eq}. Falta apenas UM número aqui.', solve: 'Assim ela sai de forma exata: {eq}.' },
    combo: { look: 'Veja esta conta: {eq}. Faltam vários números …', only: '… mas só UMA combinação da reserva serve ({n} casas).' },
    cross: { look: 'Esta casa pertence a {n} contas ao mesmo tempo.', only: 'Só um número serve para as duas: {a} e {b}.' },
    pool: { look: 'O {v} está {n} vez(es) na reserva.', only: 'E cabe em exatamente {n} casas – então cada uma recebe um {v}.' },
    place: 'Então aqui vai o {v}.',
    placeMulti: 'Com isso {n} casas ficam definidas.',
  },
  achievements: {
    title: 'Conquistas',
