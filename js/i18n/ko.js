...
export default {
  ...
  tutor: {
    ...
    next: '다음',
    apply: '이해했어요 – 적용',
    direct: { look: '이 식을 보세요: {eq}. 여기에는 숫자가 하나만 빠져 있습니다.', solve: '그래서 정확히 계산할 수 있습니다: {eq}.' },
    combo: { look: '이 식을 보세요: {eq}. 여러 숫자가 빠져 있습니다 …', only: '… 하지만 보유 칸에서 들어맞는 조합은 단 하나뿐입니다 ({n}칸).' },
    cross: { look: '이 칸은 동시에 {n}개의 식에 속합니다.', only: '둘 다에 맞는 숫자는 하나뿐입니다: {a} 그리고 {b}.' },
    pool: { look: '{v}은(는) 보유 칸에 {n}개 있습니다.', only: '그리고 정확히 {n}칸에만 맞습니다 – 그래서 모두 {v}이(가) 들어갑니다.' },
    place: '그러므로 여기에는 {v}이(가) 들어갑니다.',
    placeMulti: '이로써 {n}칸이 정해집니다.',
  },
  achievements: {
    title: '업적',
  ...
  howto: {
    title: '게임 방법',
    rule1: '아래 <b>보유 칸</b>의 숫자를 빈 칸으로 끌어다 놓으세요.',
    rule2: '가로와 세로의 <b>모든 식</b>이 맞아야 합니다. 예: <b>7 × 3 = 21</b>.',
    rule3: '<b>양의 정수</b>만 사용합니다 — 소수도, 음수 결과도 없습니다.',
    rule4: '이미 찬 칸에 놓으면 두 타일이 <b>자리를 바꿉니다</b>. <b>정렬 버튼</b>은 보유 칸을 오름차순으로 정리합니다.',
