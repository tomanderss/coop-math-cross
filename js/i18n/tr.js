...
export default {
  ...
  game: {
    ...
    pauseTitle: 'Duraklat',
    undoTitle: 'Geri al',
    sortTitle: 'Stoku sırala',
    hintTitle: 'İpucu',
    noHint: 'Şu anda işe yarayan bir ipucu yok.',
  ...
  tutor: {
    ...
    next: 'Devam',
    apply: 'Anladım – uygula',
    direct: { look: 'Şu işleme bak: {eq}. Burada yalnızca BİR sayı eksik.', solve: 'Böylece tek bir sonuç çıkar: {eq}.' },
    combo: { look: 'Şu işleme bak: {eq}. Birden fazla sayı eksik …', only: '… ama stoktan yalnızca TEK bir yerleşim uyuyor ({n} kare).' },
    cross: { look: 'Bu kare aynı anda {n} işleme ait.', only: 'İkisine birden yalnızca tek bir sayı uyuyor: {a} ve {b}.' },
    pool: { look: '{v} stokta {n} kez var.', only: 'Ve tam olarak {n} kareye uyuyor – yani hepsine bir {v} gelir.' },
    place: 'Yani buraya {v} gelir.',
    placeMulti: 'Böylece {n} kare belirlenmiş olur.',
  },
  achievements: {
    title: 'Başarımlar',
