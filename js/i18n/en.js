...
export default {
  ...
  diffShift: { toast: 'Every difficulty moved down one step and a new, harder R.I.P. waits at the top — your stats moved along with them.' },
  endless: { badge: 'Endless', best: 'Best run: level {n}', cleared: 'Level {n} cleared!', lifeGained: '+1 life', overTitle: 'Run over', reached: 'Reached level {n}', record: 'New record!', levelDone: 'Level {n} cleared!', continue: 'Continue', livesLabel: 'Lives', levelShort: 'Level {n}', levelTime: 'Time for this level', totalTime: 'Total run time', backfillToast: 'Past endless runs credited: {wins} wins from {runs} runs now count in your stats!', waitingForNextLevel: 'Level {level} cleared — waiting for the host to start the next level …' },

  saves: { title: 'Saved games', manage: 'Manage saved games', moreN: 'More saved games ({n})', livesLeft: '{n} of {max} lives left', openN: 'All saved games ({n})', intro: 'Every game is saved separately — start a new one whenever you like, the old save stays. Room for {max} saves.', running: 'running', delete: 'Delete', deleteTitle: 'Delete save?', deleteMsg: 'This save will be removed for good.', deleted: 'Save deleted', empty: 'No saved games yet.', justNow: 'just now', minsAgo: '{n} min ago', hoursAgo: '{n} h ago', yesterday: 'yesterday', daysAgo: '{n} days ago' },
  ...
  soloInvite: {
    ...
    share: 'Share code',
    shareText: 'Play Math Cross with me! Join my running game – room code: {code}',
    copied: 'Code copied',
  ...
  settings: {
    ...
    dragScale: 'Drag reach',
    dragScaleHint: 'The tile you drag follows your finger amplified: at 3x a short move sends it three times as far, so you reach the top of the board without dragging across the whole screen. It always drops where the tile is shown.',
    dragScaleOff: '1x (off)',
    dragScaleOn: '{f}x',
    colorBlindMode: 'Colorblind-friendly mode',
    colorBlindModeHint: 'Replaces green/red everywhere in the game (correct/wrong, lives, co-op colors, ...) with more distinguishable tones for red-green/blue-yellow color vision deficiency.',
    coop: 'Co-op',
  ...
  training: {
    title: 'Next step',
    apply: 'Got it – apply',
    step: { direct: 'Only one number is missing in this equation: {eq} → the {v}.' },
  },
  achievements: {
    title: 'Achievements',
    ...
    perfectWin: { title: 'Flawless', desc: 'Solve a puzzle with no mistakes at all.' },
    perfectTen: { title: 'Flawless streak', desc: 'Win 10 puzzles with no mistakes.' },
    ...
    bigPerfect: { title: 'Big & flawless', desc: 'Win a Big Numbers puzzle with no mistakes.' },
  ...
  share: {
    button: 'Share',
    coopInvite: 'Play Coop Math Cross with me in co-op mode! Code: {code} — {url}',
  },
  howto: {
    title: 'How to play',
    rule1: 'Place the numbers from the <b>tray</b> below into the empty cells — either <b>drag</b> them or <b>tap</b> a number and then tap the cell.',
    ...
    rule4: 'Two placed tiles <b>swap</b>: tap one (it stays selected), then tap the other. Dragging works just as well.',
  ...
  a11y: {
    cellLabel: 'Row {row}, column {col}, {status}',
    cellGiven: 'given',
    cellEmpty: 'empty',
    cellFilled: 'holds {value}',
  },
  error: {
  },
};
