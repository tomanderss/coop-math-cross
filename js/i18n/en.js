...
export default {
  ...
  game: {
    ...
    sortTitle: 'Sort tray',
    hintTitle: 'Hint',
    noHint: 'No hint available right now.',
  ...
  tutor: {
    ...
    next: 'Next',
    apply: 'Got it – apply',
    direct: { look: 'Look at this equation: {eq}. Only ONE number is missing here.', solve: 'So it can be worked out exactly: {eq}.' },
    combo: { look: 'Look at this equation: {eq}. Several numbers are missing …', only: '… but only ONE filling from the tray fits ({n} cells).' },
    cross: { look: 'This cell belongs to {n} equations at once.', only: 'Only a single number fits both: {a} and {b}.' },
    pool: { look: 'The {v} is in the tray {n} time(s).', only: 'And it fits exactly {n} cells – so every one of them takes a {v}.' },
    place: 'So the {v} goes here.',
    placeMulti: 'That settles {n} cells.',
  },
  achievements: {
    title: 'Achievements',
