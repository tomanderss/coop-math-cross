...
export const DIFFICULTIES = [
  ...
  { id: 'mashallah',  name: 'Mashallah',   emoji: 'skull',      dim: { r: 7, c: 6 }, eqTarget: 19, ops: ['+', '-', '*', '/'], maxOperand: 18, maxResult: 150, ternaryChance: 0.10, blankRatio: 0.62, maxTier: 3,   genBudget: 60, accent: '#c7cdd6', accentD: '#7f8a99', heat: 0.64 },
  { id: 'dikkawas',   name: 'Dikka was',   emoji: 'ghost',      dim: { r: 7, c: 7 }, eqTarget: 23, ops: ['+', '-', '*', '/'], maxOperand: 18, maxResult: 160, ternaryChance: 0.15, blankRatio: 0.64, maxTier: 3,   genBudget: 70, accent: '#b9a5ff', accentD: '#6b57c0', heat: 0.77 },
  { id: 'bismillah',  name: 'Bismillah',   emoji: 'meteor',     dim: { r: 8, c: 7 }, eqTarget: 27, ops: ['+', '-', '*', '/'], maxOperand: 20, maxResult: 180, ternaryChance: 0.20, blankRatio: 0.65, maxTier: 3,   genBudget: 70, accent: '#ff7a1a', accentD: '#b34e08', heat: 0.89 },
  { id: 'rip',        name: 'R.I.P.',      emoji: 'grave',      dim: { r: 9, c: 7 }, eqTarget: 32, ops: ['+', '-', '*', '/'], maxOperand: 20, maxResult: 200, ternaryChance: 0.25, blankRatio: 0.66, maxTier: 3,   genBudget: 80, accent: '#aab3bd', accentD: '#5a636e', heat: 1.00 },
];
